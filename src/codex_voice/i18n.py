...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "status.error": "Error",
        "detail.recording_hint": "Recording. Press the shortcut again or use Submit to transcribe",
        ...
        "notify.recording": "Recording. Press the shortcut again or use Submit when ready.",
        ...
        "cli.started": "Codex Voice recording started. Press the shortcut again or use Submit when ready. PID: {pid}",
        ...
        "route.direct_asr": "Direct ASR",
        "route.two_stage": "Two-stage Enhanced",
        "cli.processing_route": "Processing route: {route}",
        "cli.direct_asr_model": "Direct ASR model: {model}",
        "cli.transcription_model": "MLX transcription model: {model}",
        "cli.correction_model": "MLX correction model: {model}",
        ...
        "cli.set_processing_route": "Codex Voice processing route set to: {route}",
        "cli.set_direct_asr_model": "Codex Voice Direct ASR model set to: {model}",
        "cli.set_transcription_model": "Codex Voice transcription model set to: {model}",
        "cli.set_correction_model": "Codex Voice correction model set to: {model}",
        "cli.correction_enabled": "Codex Voice text correction enabled: {model}",
        "cli.correction_disabled": "Codex Voice text correction disabled: {model}",
        "task.idle": "Idle",
    ...
    "zh-Hans": {
        ...
        "status.error": "出错",
        "detail.recording_hint": "正在录音。准备好后再次按快捷键或点击提交进行转写",
        ...
        "notify.recording": "正在录音。准备好后再次按快捷键或点击提交。",
        ...
        "cli.started": "Codex Voice 已开始录音。准备好后再次按快捷键或点击提交。PID：{pid}",
        ...
        "route.direct_asr": "直接 ASR",
        "route.two_stage": "两阶段增强",
        "cli.processing_route": "处理路线：{route}",
        "cli.direct_asr_model": "直接 ASR 模型：{model}",
        "cli.transcription_model": "MLX 转录模型：{model}",
        "cli.correction_model": "MLX 纠错模型：{model}",
        ...
        "cli.set_processing_route": "Codex Voice 处理路线已设置为：{route}",
        "cli.set_direct_asr_model": "Codex Voice 直接 ASR 模型已设置为：{model}",
        "cli.set_transcription_model": "Codex Voice 转录模型已设置为：{model}",
        "cli.set_correction_model": "Codex Voice 纠错模型已设置为：{model}",
        "cli.correction_enabled": "Codex Voice 已启用文本纠错：{model}",
        "cli.correction_disabled": "Codex Voice 已关闭文本纠错：{model}",
        "task.idle": "空闲",
    ...
    "zh-Hant": {
        ...
        "status.error": "出錯",
        "detail.recording_hint": "正在錄音。準備好後再次按快捷鍵或點擊提交進行轉寫",
        ...
        "notify.recording": "正在錄音。準備好後再次按快捷鍵或點擊提交。",
        ...
        "cli.started": "Codex Voice 已開始錄音。準備好後再次按快捷鍵或點擊提交。PID：{pid}",
        "cli.canceled_by_user": "Codex Voice 已取消。",
        ...
        "route.direct_asr": "直接 ASR",
        "route.two_stage": "兩階段增強",
        "cli.processing_route": "處理路線：{route}",
        "cli.direct_asr_model": "直接 ASR 模型：{model}",
        "cli.transcription_model": "MLX 轉錄模型：{model}",
        "cli.correction_model": "MLX 校正模型：{model}",
        ...
        "cli.set_processing_route": "Codex Voice 處理路線已設定為：{route}",
        "cli.set_direct_asr_model": "Codex Voice 直接 ASR 模型已設定為：{model}",
        "cli.set_transcription_model": "Codex Voice 轉錄模型已設定為：{model}",
        "cli.set_correction_model": "Codex Voice 校正模型已設定為：{model}",
        "cli.correction_enabled": "Codex Voice 已啟用文字校正：{model}",
        "cli.correction_disabled": "Codex Voice 已關閉文字校正：{model}",
        "task.idle": "閒置",
        "task.state_unreadable": "模型任務狀態不可讀",
        "task.unload_model": "卸載模型：{model}",
        "task.download_model": "下載 {model}",
        "task.prepare_model": "載入 {model}",
        "task.downloading_model": "下載模型中",
        "task.loading_model": "載入模型中",
        "task.downloading_modelscope": "正在從 ModelScope 下載",
        "task.loading_mlx_memory": "正在將模型載入 MLX 記憶體",
    ...
    "ja": {
        ...
        "status.error": "エラー",
        "detail.recording_hint": "録音中です。準備できたらもう一度ショートカットを押すか送信を押してください",
        ...
        "notify.recording": "録音中です。準備できたらもう一度ショートカットを押すか送信を押してください。",
        ...
        "cli.started": "Codex Voice の録音を開始しました。準備できたらもう一度ショートカットを押すか送信を押してください。PID: {pid}",
        ...
        "route.direct_asr": "直接 ASR",
        "route.two_stage": "2 段階強化",
        "cli.processing_route": "処理ルート: {route}",
        "cli.direct_asr_model": "直接 ASR モデル: {model}",
        "cli.transcription_model": "MLX 音声認識モデル: {model}",
        "cli.correction_model": "MLX 補正モデル: {model}",
        ...
        "cli.set_processing_route": "Codex Voice 処理ルートを設定しました: {route}",
        "cli.set_direct_asr_model": "Codex Voice 直接 ASR モデルを設定しました: {model}",
        "cli.set_transcription_model": "Codex Voice 音声認識モデルを設定しました: {model}",
        "cli.set_correction_model": "Codex Voice 補正モデルを設定しました: {model}",
        "cli.correction_enabled": "Codex Voice テキスト補正を有効にしました: {model}",
        "cli.correction_disabled": "Codex Voice テキスト補正を無効にしました: {model}",
        "task.idle": "待機中",
